...
function updateStreakAndGenerateSnippetStandard(isCorrect, playerName, resultElement, nextPlayerCallback) {
    if (isCorrect) {
        ...
        if (correctStreakStandard === 1) {
            ...
            let shareText = `3 in a row! That's a PLUNK🏀!<br>Players: ${lastThreeCorrectStandard.join(', ')}<br>Challenge your pals with this PLUNK🏀: ${shareLink}`;
